//O principal objetivo deste desafio é fortalecer suas habilidades em lógica de programação. Aqui você deverá desenvolver a lógica para resolver o problema.
		...
		//O principal objetivo deste desafio é fortalecer suas habilidades em lógica de programação. Aqui você deverá desenvolver uma lógica para resolver o problema.
		...
		// Criando uma lista vazia para salvar os nomes
		const nomes = [ ] ;
		...
		// Adicionado o nome na lista visível na página
		...
		inputAmigo.value = '';
		inputAmigo . foco ( ) ; // Coloca o cursor no campo de texto novamente
		}
		

		// Função para classificar um amigo
		function sortearAmigo() {
		// Verifica se a lista está vazia
		if (nomes.length === 0) {
		alert('A lista está vazia! Adicione nomes antes de classificar.');
		retornar;
		}
